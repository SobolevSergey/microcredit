...
public class SendSMSAction implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {		
		...
		actionProcessor.sendSMSKProduct(productId,peopleMainId, procDefKey, smsMessageCode, new Object[] {oParam0, oParam1, oParam2, oParam3, oParam4});	
	}
