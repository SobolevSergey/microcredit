...
public class CalcDebugModelListener implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		Integer businessObjectId=(Integer) varsLocal.get(ProcessKeys.VAR_BUSINESS_OBJECT_ID);
		...
		try {
			//actProc.calcModelObject(modelKey, ds, businessObjectClass, businessObject, actionContext, modelId);
