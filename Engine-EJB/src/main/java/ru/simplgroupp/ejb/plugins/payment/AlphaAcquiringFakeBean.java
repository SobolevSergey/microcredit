...
import ru.simplgroupp.interfaces.plugins.payment.AlphaAcquiringBeanLocal;
...
@Local(AlphaAcquiringBeanLocal.class)
public class AlphaAcquiringFakeBean  extends AbstractPluginBean implements AlphaAcquiringBeanLocal {
	...
	public String getSystemName() {
		return AlphaAcquiringBeanLocal.SYSTEM_NAME;
	}
	...
	public String getSystemDescription() {
		return AlphaAcquiringBeanLocal.SYSTEM_DESCRIPTION;
	}	
}
