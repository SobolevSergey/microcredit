...
public class ScoreValueType {
    ...
    public static class ScoreValue {
        ...
        protected ResultBooleanType currentVersion;
         ...
         * @return
         *     possible object is
         *     {@link ResultBooleanType }
         *     
         */
        public ResultBooleanType getCurrentVersion() {
         ...
         *     
         */
        public void setCurrentVersion(ResultBooleanType value) {
