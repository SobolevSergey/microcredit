...
@XmlType(name = "CustomerType", namespace = "urn:mclsoftware.co.uk:hunterII", propOrder = {
    "customerID",
    "customerName"
})
public class CustomerType {

    @XmlElement(name = "CustomerID", namespace = "urn:mclsoftware.co.uk:hunterII", required = true)
    protected BigInteger customerID;
    @XmlElement(name = "CustomerName", namespace = "urn:mclsoftware.co.uk:hunterII", required = true)
