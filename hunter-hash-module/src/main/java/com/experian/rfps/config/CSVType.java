...
import com.experian.rfps.config.TABLEType;
import org.w3c.dom.Document;

public class CSVType extends Node {
   public CSVType(CSVType node) {
      super((Node)node);
   }

   public CSVType(org.w3c.dom.Node node) {
      super(node);
   }

   public CSVType(Document doc) {
      super(doc);
   }

   public CSVType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
