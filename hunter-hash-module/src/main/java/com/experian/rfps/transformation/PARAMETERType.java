...
public class PARAMETERType extends Node {
   public PARAMETERType(PARAMETERType node) {
      super((Node)node);
   }

   public PARAMETERType(org.w3c.dom.Node node) {
      super(node);
   }
   ...
   public PARAMETERType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
