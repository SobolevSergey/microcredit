...
var a=$("<a class=\"pagination-link\" href=\"#\"></a>").appendTo(td);
...
var t=$("<a href=\"#\"></a>").addClass(opts.tools[i].iconCls).appendTo(tool);
...
if(opts.collapsible){
$("<a class=\"panel-tool-collapse\" href=\"#\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.minimizable){
$("<a class=\"panel-tool-min\" href=\"#\"></a>").appendTo(tool).bind("click",function(){
_20e(_1eb);
return false;
});
}
if(opts.maximizable){
$("<a class=\"panel-tool-max\" href=\"#\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.closable){
$("<a class=\"panel-tool-close\" href=\"#\"></a>").appendTo(tool).bind("click",function(){
_1ee(_1eb);
return false;
});
}
...
var _25a=$("<a href=\"#\"></a>").appendTo(_259);
if(p.handler){
...
$("<a></a>").attr("href","#").text(_275).css("margin-left",10).bind("click",eval(_274[_275])).appendTo(tb).linkbutton();
}
}
...
var t=$("<a href=\"#\"></a>").addClass("accordion-collapse accordion-expand").appendTo(tool);
...
opts.tab.append("<a href=\"#\" class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<span class=\"tabs-icon\"></span>"+"</a>");
...
$("<a href=\"#\" class=\"tabs-close\"></a>").appendTo(tab);
}else{
...
if(!t.length){
t=$("<a href=\"#\"></a>").addClass(_369).appendTo(tool);
...
function _3f7(item){
_3f6.searchbox.find("a.searchbox-menu").remove();
var mb=$("<a class=\"searchbox-menu\" href=\"#\"></a>").html(item.text);
...
var t=$("<a href=\"#\"></a>").html($.isFunction(btn.text)?btn.text(_8d6):btn.text).appendTo(td);
...
(function($){
function init(_918){
var _919=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"#\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_918);
var t=$(_918);
