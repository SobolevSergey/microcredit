 ...
 */
public class GetStateMethodAssembler extends BaseAppServAssembler implements IAppServAssembler {
    private static final Logger logger = Logger.getLogger(GetStateMethodAssembler.class.getName());
    ...
    public byte[] createAppServ(Map<String, String> attrData,boolean sign,Map<String, String> childrenData) {
        ...
        attrMap.put(BaseDoc.INOUT, attrData.get(BaseDoc.INOUT));
    ...
    public String getMethodName() {
        return BaseAppServAssembler.GET_STATE_OUTGOING_METHOD;
    }
