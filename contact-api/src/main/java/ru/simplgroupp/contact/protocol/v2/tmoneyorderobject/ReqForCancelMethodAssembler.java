 ...
 */
public class ReqForCancelMethodAssembler extends BaseAppServAssembler implements IAppServAssembler {
    private static final Logger logger = Logger.getLogger(ReqForCancelMethodAssembler.class.getName());
    ...
    public String getMethodName() {
        return BaseAppServAssembler.REQ_FOR_CANCEL_METHOD;
    }
